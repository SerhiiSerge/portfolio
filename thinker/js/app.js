 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".slider__swiper")) new core(".slider__swiper", {
        ...
        function toTopScroll() {
            ...
            window.onscroll = function() {
                if (document.body.scrollTop > 1500 || document.documentElement.scrollTop > 1500) document.documentElement.classList.add("to-top-visible"); else document.documentElement.classList.remove("to-top-visible");
            };
            if (toTopButton) document.addEventListener("click", (function(e) {
                if (e.target.closest(".to-top__button")) {
            ...
            galleries.forEach((gallery => {
                galleryItems.push({
                    ...
                    galleryClass: lightgallery_es5(gallery, {
                        plugins: [ lg_fullscreen_min, lg_thumbnail_min ],
