(() => {
        ...
        window.addEventListener("load", (function(e) {
            ...
            function getHeight(showMoreBlock, showMoreContent) {
                ...
                if (showMoreType === "items") {
                    ...
                    const showMoreTypeValue = showMoreContent.dataset.showmoreContent ? showMoreContent.dataset.showmoreContent : 210;
    ...
    function formSubmit() {
        ...
        function formSent(form, responseResult = ``) {
            ...
            formValidate.formClean(form);
            formLogging(`The form has been sent!`);
        }
    ...
    if (document.querySelector(".form__button")) document.addEventListener("click", (function(e) {
        if (e.target.closest(".form__button")) document.documentElement.classList.add("required"); else if (document.querySelector("#tel-input") === document.activeElement) document.documentElement.classList.remove("required");
    }));
    window["FLS"] = false;
    isWebp();
    addTouchClass();
